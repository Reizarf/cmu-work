...
int main()
{
    ...
    //createa pointer integer set it = to function
    //create integer function with counting and num of comparisons

    //create reset function^^

    //in functions int * position = new int[10000];
